...
const SDK_URL = 'https://cdn.bitmovin.com/player/web/8.1.0/bitmovinplayer.js'
...
function getBitrate(cookie = {bitrate: HIGHEST_BITRATE}) {
  return cookie.bitrate || HIGHEST_BITRATE
}
...
export default class Bitmovin extends Base {
  ...
  constructor(props) {
    super(props)
    const url = props.dash_url || props.hls_url
  ...
  getConfig(props) {
    const {poster, subtitlesUrl, videoQualityCookie, title, description} =
      props || this.props
    const bitrate = getBitrate(videoQualityCookie)
    return {
      ...
      location: {
        ui:
          'https://res.cloudinary.com/dg3gyk0gu/raw/upload/v1582674802/player/bitmovinplayer-ui.js',
        ui_css:
          'https://res.cloudinary.com/dg3gyk0gu/raw/upload/v1582674802/player/bitmovinplayer-ui.css',
      },
      poster: poster,
      tracks: [
        {
